...
SELECT f.id, f.razaosocial, f.nomefantasia, f.endereco, f.numero, f.bairro, m.descricao AS municipio, f.cep, e.descricao AS estado, 
f.telefone, ti.descricao as "tipo inscricao", f.inscricaoestadual, f.cnpj as "cnpj/cpf", tr.descricao as "tipo pagamento", 
fpp.diasentregapedido AS "dias entrega pedido", fpp.diasatualizapedidoparcial as "dias atual. ped parcial", MAX(ne.dataentrada)
